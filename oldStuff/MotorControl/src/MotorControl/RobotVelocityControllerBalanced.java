...
public class RobotVelocityControllerBalanced extends RobotVelocityController {
  ...
  public void controlStep(double[] controlOutput) {
    ...
    // Factor it in appropriately to the individual wheel velocities
    ldv = this.gain*angularDiffError + desiredAngularVelocity[RobotBase.LEFT];
    rdv = -this.gain*angularDiffError + desiredAngularVelocity[RobotBase.RIGHT];
