 ...
 * @author vona
 **/
public class ChallengeGUI extends MapGUI implements NodeMain {
	 ...
	 **/
	public ChallengeGUI(int poseSaveInterval, double maxTV, double maxRV) {
	 ...
	 **/
	public ChallengeGUI(int poseSaveInterval) {
