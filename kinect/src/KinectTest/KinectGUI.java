...
public class KinectGUI extends VisionGUI {
	/**
	 * <p>The application name.</p>
	 **/
	public static final String APPNAME = "KinectGUI";
	 ...
	 **/
	public KinectGUI(int poseSaveInterval, double maxTV, double maxRV) {
	 ...
	 **/
	public KinectGUI(int poseSaveInterval) {
