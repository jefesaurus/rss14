...
public class Grid implements Iterable<Grid.Cell> {
  ...
  public Grid(Rectangle2D.Double worldBounds, double resolution) {
    ...
    rows = (int)(worldBounds.height/resolution)+1;
    cols = (int)(worldBounds.width/resolution)+1;
  ...
  public Cell getCell(Point2D.Double point) {
    ...
    // Written by Daniel
    int r = (int)((point.y - worldBounds.y)/resolution);
    int c = (int)((point.x - worldBounds.x)/resolution);
    // End of Daniel's
